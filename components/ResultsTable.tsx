    ...
    <div className="card flex h-full flex-col gap-4 p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <h3 className="text-lg font-semibold text-white">Ultimos scraping</h3>
        </div>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-5">
        <div className="col-span-2 flex items-center gap-2 rounded-lg border border-white/10 bg-black/30 px-3">
      ...
      <div className="flex-1 overflow-auto rounded-lg border border-white/5">
        <table className="min-w-full text-sm text-white/80">
          ...
          <tbody>
            {results.map((r) => (
              <tr key={r.id || r.url} className="border-t border-white/5">
                ...
                <td className="px-3 py-2 max-w-[240px] break-all text-xs text-white/70">
                  <a href={r.url} target="_blank" className="text-emerald-300 hover:underline">
                    {r.url}
                  </a>
                </td>
              </tr>
